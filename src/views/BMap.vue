...
const testPoint2 = [
  {  name: '北京',  value: [116.404269, 39.913385, 200]},
  {  name: '上海',  value: [121.475941, 31.222836, 150]}
]
const data = [
  { name: '海门', value: 9 },
  { name: '鄂尔多斯', value: 12 },
...
export default {
  ...
  mounted() {
    this.options = {
      ...
      bmap: {
        key: 'ANmAPlDKytRtLATFxXBhN1AVy3aGkeXG',
      ...
      series: [{
        ...
        type: 'effectScatter',
        coordinateSystem: 'bmap',
        data: converData(data.sort((a,b) => b.value - a.value)).slice(0, 10),
        symbolSize: function(val) {
          return val[2] / 10
        },
        itemStyle: {
